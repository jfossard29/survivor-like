...
var area: Area3D = null  # sera créé dans _ready()
...
func _ready():
	...
	# Layer / Mask
	area.collision_layer = 1 << 9   # bit 9 = 512 (tu peux mettre 519 si tu veux ajouter d'autres bits)
...
func _on_area_entered(other_area):
	target_backward = true   # Animation revient vers le début
...
func _on_area_exited(other_area):
	target_forward = true    # Animation retourne vers la fin
